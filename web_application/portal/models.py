...
class Feedback_Complains(models.Model):
    ...
    type = models.CharField(max_length=225,null=True,blank=False,choices = Type)
    ...
    reply = models.CharField(max_length=255,null=True,blank=True, default='None')

    def __str__(self):
        return f'Feedback for  { str(self.created_by)}'
